# Part 1: Exploring, processing, gaining insight from the data by Watt The Data

We have a dataset containing information on approximately 100,000 electric car charging sessions. The training data spans from January 2022 to June 2024 and contains  sessions using fast chargers by Eveny. The chargers in use have nominal power ratings ranging from 50 DC to 400 DC, providing a diverse set of data points for analysis. The dataset includes following features: IDs, sub IDs, State of Charges (SoC), charging powers, nominal_powers, location IDs and timestamps.
...
<div style="display: flex; align-items: center;">
    <div style="flex: 1;">
        <p>
            ...
            Fast chargers with nominal power ratings ranging from 50 DC to 400 DC are represented. 
            Here we can see that we have a wide distribution of different nominal chargings used.
        </p>
    </div>
    <div>
        <img src="visualizations/distributions%20of%20nominal%20powers.png" width="280" height="280">
    </div>
</div>
...
<img src="visualizations/power%20vs%20soc.png" width="750" height="250">
...
<img src="visualizations/median%20power%20season.png" width="750" height="250">
...
<img src="visualizations/median%20power%20month.png" width="750" height="250">
...
<img src="visualizations/invalid%20observations.png" width="750" height="250">
...
<img src="visualizations/missing%20values%20for%20power%20and%20soc.png" width="750" height="250">
